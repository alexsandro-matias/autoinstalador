...
def libreoffice():
    url = "https://download.jetbrains.com/idea/ideaIC-2021.3.2.win.zip?_gl=1*12o8pvj*_ga*ODQ5ODMzNzcuMTY0NDM1NjUzOQ..*_ga_V0XZL7QHEB*MTY0NDM1NjUzOC4xLjEuMTY0NDM1NzA5Mi4w&_ga=2.162526972.1534647027.1644356540-84983377.1644356539"
    r = requests.get(url, stream=True)
    with open("arquivo.exe", 'wb') as f:
        f.write(r.content)
        print('Arquivo baixado com sucesso.')
